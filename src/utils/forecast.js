...
const forecast = (latitude, longitude, callback) => {
    ...
    request({ url, json: true }, (error, { body }) => {
        if (error) {
            ...
            callback(undefined, 
                body.daily.data[0].summary +' It is corrently ' + 
                body.currently.temperature +' degrees out. There is a ' + 
                body.currently.precipProbability + "% chance of rain. Feels Like: " +
                body.currently.apparentTemperature + " Low: " +
                body.daily.data[0].temperatureLow + " High: " +
